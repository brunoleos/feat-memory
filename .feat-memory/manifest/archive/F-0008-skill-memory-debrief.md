...
acceptance:
  ...
  - id: A4
    ...
    response: >
      invoca feat-memory propose-adr (F-0003) para gerar draft em
...
SKILL.md em [src/feat_memory/data/skills/memory-debrief/SKILL.md](src/feat_memory/data/skills/memory-debrief/SKILL.md). A skill mais usada no dia-a-dia. Cobre o momento em que o trabalho realizado precisa ser refletido na memória persistente antes de virar commit.
