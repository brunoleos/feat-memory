...
contracts:
  api:
    - src/feat_memory/governance/audit.py::released_versions
    - src/feat_memory/governance/audit.py::validate_release_status
    - src/feat_memory/governance/audit.py::run_audit
    - src/feat_memory/governance/audit.py::print_report
    - src/feat_memory/governance/audit.py::STALENESS_WARN_HOURS
  tests:
