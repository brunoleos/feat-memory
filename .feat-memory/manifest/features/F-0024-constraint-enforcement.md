...
user_value: >
  ...
  declarar um bloco `check` que o `feat-memory audit` executa contra o
...
contracts:
  api:
    - src/feat_memory/governance/constraints.py::check_constraints
    - src/feat_memory/governance/constraints.py::validate_check_shape
    - src/feat_memory/governance/constraints.py::CHECKERS
    - src/feat_memory/governance/audit.py::run_audit
    - src/feat_memory/governance/audit.py::print_report
  tests:
