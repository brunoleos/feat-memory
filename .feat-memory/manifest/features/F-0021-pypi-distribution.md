...
version: 0.11.0
user_value: >
  usuário final instala com `pipx install feat-memory` (sem clonar) e cada tag
...
acceptance:
  - {id: A1, pattern: ubiquitous, requirement: "package-data declara hooks sob `feat_memory.governance` e templates/skills sob `feat_memory`; todo arquivo de runtime de deploy._data_path é coberto por algum glob"}
