...
ADR-0013 definiu `.feat-memory/.meta.yaml` para registrar contra qual versão da
metodologia a estrutura foi produzida. Entre os campos estava `cli_path`: o caminho
absoluto resolvido do binário `feat-memory` na máquina de quem rodou o deploy
