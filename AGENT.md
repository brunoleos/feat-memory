...
Este repositório é a fonte da tool e ao mesmo tempo um projeto consumidor da metodologia (C3). Para instalar/atualizar a CLI a partir do código local, use **pipx editable install** — é o mecanismo de distribuição formalizado em [ADR-0007](decisions/0007-distribute-as-pipx-package.md):
