...
Subcomando da CLI: `feat-memory check-version-bump-staged`. Inspeciona o
...
fonte da verdade ganham o guard automaticamente após `feat-memory deploy`.
...
ERROR_TEXT = (
    "feat-memory: commit toca código mas VERSION não foi atualizado.\n"
