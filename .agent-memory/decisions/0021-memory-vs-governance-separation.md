...
- **Dois pacotes pip distintos**: mais "totalmente independente" no literal, mas usuário disse para manter `agent-memory deploy` instalando tudo. Caminho fica aberto se um dia justificar.
