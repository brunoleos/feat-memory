...
acceptance:
  ...
  - {id: A6, pattern: state, state: "a AGENTS.md está sem frontmatter (campos ausentes) e o CLI é mais novo que a versão deployada", response: "o audit imprime a remediação dirigida — re-rode `agent-memory deploy` para injetar o esqueleto"}
depends_on: []
decisions: [ADR-0029]
---
