...
contracts:
  api:
    - src/agent_memory/shared/paths.py::_init_paths
    - src/agent_memory/deploy.py::add_subparser
    - src/agent_memory/governance/audit.py::add_subparser
    - src/agent_memory/memory/migrate.py::add_subparser
  tests:
    - tests/test_cli.py
