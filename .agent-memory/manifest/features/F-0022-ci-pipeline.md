...
contracts:
  ...
  tests: []
acceptance:
  - {id: A1, pattern: event, trigger: "push em main ou abertura de PR", response: "ci.yml roda a matriz {ubuntu,macos,windows} × {3.11,3.12}: install editable, pytest, `agent-memory audit --strict --json`"}
